...
const MENU_CONFIG = {
  awardee: [
    ...
    { id: 'attendance', label: 'Absensi Pembinaan', icon: ClipboardCheck },
  ...
  mentor: [
    ...
    { id: 'attendance', label: 'Monitoring Absensi', icon: ClipboardCheck },
    { id: 'pengumuman', label: 'Pengumuman', icon: Megaphone },
    { id: 'sessions', label: 'Sesi Pembinaan', icon: Calendar },
    { id: 'profile', label: 'Profil Saya', icon: UserCheck },
  ],
  superadmin: [
    { id: 'dashboard', label: 'Dashboard Konsolidasi', icon: Compass },
    { id: 'users', label: 'Manajemen User', icon: Users },
    { id: 'attendance', label: 'Kelola Presensi', icon: ClipboardCheck },
    { id: 'pengumuman', label: 'Pengumuman', icon: Megaphone },
